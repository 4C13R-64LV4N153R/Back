...
async function main() {
    try {
        ...
        const coca500ml = await prisma.produit.create({
            data: { nom: 'Coca-Cola', contenance: 500, unite: 'ml', partenaire_id: partenaireA.partenaire_id, img_url: 'https://global.discourse-cdn.com/business4/uploads/neomonstersforum/original/3X/3/7/3785350db3411362475773793576fc7923b0da98.jpeg' }
        });
        const eau1000ml = await prisma.produit.create({
            data: { nom: 'Eau', contenance: 1000, unite: 'ml', partenaire_id: partenaireB.partenaire_id, img_url: 'https://global.discourse-cdn.com/business4/uploads/neomonstersforum/original/3X/3/7/3785350db3411362475773793576fc7923b0da98.jpeg' }
        });
        const biere1500ml = await prisma.produit.create({
            data: { nom: 'Bière', contenance: 1500, unite: 'ml', partenaire_id: partenaireA.partenaire_id, img_url: 'https://global.discourse-cdn.com/business4/uploads/neomonstersforum/original/3X/3/7/3785350db3411362475773793576fc7923b0da98.jpeg' }
        });
        const vin750ml = await prisma.produit.create({
            data: { nom: 'Vin', contenance: 750, unite: 'ml', partenaire_id: partenaireB.partenaire_id, img_url: 'https://global.discourse-cdn.com/business4/uploads/neomonstersforum/original/3X/3/7/3785350db3411362475773793576fc7923b0da98.jpeg' }
        });

        const coca1000ml = await prisma.produit.create({
            data: { nom: 'Coca-Cola', contenance: 1000, unite: 'ml', partenaire_id: partenaireA.partenaire_id, img_url: 'https://global.discourse-cdn.com/business4/uploads/neomonstersforum/original/3X/3/7/3785350db3411362475773793576fc7923b0da98.jpeg' }
        });
        const chipsLays50gr = await prisma.produit.create({
            data: { nom: 'Chips Lays', contenance: 50, unite: 'gr', partenaire_id: partenaireB.partenaire_id, img_url: 'https://global.discourse-cdn.com/business4/uploads/neomonstersforum/original/3X/3/7/3785350db3411362475773793576fc7923b0da98.jpeg' }
        });
